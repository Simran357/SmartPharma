...
const WholeSaler = () => {
  return (
   <div className="flex min-h-screen">
        <aside className="w-64 border-r  border-gray-200     bg-white flex flex-col fixed h-full z-20">
         <div className="p-6">
            <div className="flex items-center gap-3 mb-10">
               <div className="bg-blue-50 size-8 rounded flex items-center justify-center text-blue-500">
              <span className="material-symbols-outlined">
                 medical_services
              </span>
        </div>  
        <div> 
          <h1 className="text-text-main text-sm text-black font-bold leading-none">
            PharmaDistro
          </h1> 
          <p className="text-gray-400 text-[12px] mt-1">Retailer Panel</p>
        </div> 
      </div>
    </div>
    <nav className="flex flex-col  text-gray-500 gap-1">
      <a
        className="flex items-center gap-3 px-3 py-2 rounded-lg sidebar-item-active"
        href="#"
      >
        <span className="material-symbols-outlined">dashboard</span>
        <span className="text-sm  border-gray-200">Dashboard</span>
      </a> 
      <a
        className="flex items-center gap-3 px-3 py-2 rounded-lg text-text-muted hover:bg-gray-50"
        href="#"
      >
    ...
    {/* Bottom section of sidebar (profile + logout) */}
    <div className="mt-auto p-6 border-t border-gray-200">
      {/* Row container: profile image, text, logout icon */}
      <div className="flex items-center gap-3">
        {/* Profile image (round avatar using background image) */}
        <div
          className="size-10 rounded-full bg-cover bg-center "
          style={{
            backgroundImage:
              'url("https://lh3.googleusercontent.com/aida-public/AB6AXuDEUH8aB4ZhwBBV-9vHgqlSzl2guNVUPmwl8Ax-zIdWrTFuE0u9FvQUpMo8FKgB5qG8efZ4_cCMFlxrZw8v-A0fSIC50dR19fMn7DspyvH4AxdLd7npdcFi0NTEhTFH5kHqKocCbgu1TzVjiunKRUcfwaZp6v_kYy101Ebi9fc1N1Bgs_eJ_LuIq0xKMrffijXmtyMbr6H1gnj_i65q8tcVmQBiQuRXLH8dbmri3NM9Llz8JlpkZX9FjeT_jXWq3kSvHnAOQAzGnOw")'
          }}
        ></div> 
        {/* Text container (company name + account type) */}
        <div className="flex-1 min-w-0">
          {/* Company / Store name */}
          <p className="text-xs text-green-500 font-bold truncate">City Care Pharma</p>
          {/* Account type / role */}
            ...
            <table className="w-full text-left">
              ...
              <tbody className="text-xs divide-y divide-border-subtle">
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 font-bold">$850.50</td>
                  <td className="px-6 py-4">
