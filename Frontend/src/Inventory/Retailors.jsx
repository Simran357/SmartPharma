            ...
            <div className="w-64 h-full p-6 relative">
                <div className="flex items-center gap-2 ">
                    ...
                    <div className="leading-5">
                        <h3 className="text-lg font-bold">Smart Pharma</h3>
                        <span className="text-green-500 font-medium"> Wholesaler Portal</span>
                    </div>
                </div>
                ...
                <div className="mt-4 w-full">
                    ...
                    <div
                        ...
                        className={`flex items-center gap-2.5 p-5 rounded-lg cursor-pointer 
                        ${activeMenu === "dashboard" ? "bg-green-100 text-green-600" : "hover:bg-gray-100"}`}
                    >
                    ...
                    {/* Retailors (ACTIVE) */}
                    <div
                        onClick={() => setActiveMenu("retailors")}
                        className={`flex items-center gap-2.5 p-5 rounded-lg cursor-pointer 
                        ${activeMenu === "retailors" ? "bg-green-100 text-green-600" : "hover:bg-gray-100"}`}
                    >
                        <FaStore className="text-2xl" />
                        <h2 className="text-base capitalize">Retailors</h2>
                    </div>
                    ...
                    <div
                        ...
                        className={`flex items-center gap-2.5 p-5 rounded-lg cursor-pointer 
                        ${activeMenu === "orders" ? "bg-green-100 text-green-600" : "hover:bg-gray-100"}`}
                    >
                        <FaShoppingCart className="text-2xl" />
                        <h2 className="text-base capitalize">Orders</h2>
                    </div>

                    <div
                        onClick={() => setActiveMenu("settings")}
                        className={`flex items-center gap-2.5 p-5 rounded-lg cursor-pointer 
                        ${activeMenu === "settings" ? "bg-green-100 text-green-600" : "hover:bg-gray-100"}`}
                    >
                        <FaCog className="text-xl" />
                        <h2 className="text-base capitalize">Settings</h2>
                    </div>

                    <div
                        onClick={() => setActiveMenu("analytics")}
                        className={`flex items-center gap-2.5 p-5 rounded-lg cursor-pointer 
                        ${activeMenu === "analytics" ? "bg-green-100 text-green-600" : "hover:bg-gray-100"}`}
                    >
                        <FaChartBar className="text-2xl" />
                        <h2 className="text-base capitalize">Analytics</h2>
                    </div>

                </div>

                {/* Profile */}
                <div className="flex items-center gap-1.5 p-4 m-auto absolute bottom-3">
                    <img
                        src="https://i.pinimg.com/474x/ab/df/f4/abdff4e84298c600ca6a9024370a29c8.jpg?nii=t"
                        alt=""
                        className="object-cover rounded-full h-10 w-10"
                    />
                    <div className="leading-4.5">
                        <h3 className="text-base font-bold">Alex Rivera</h3>
